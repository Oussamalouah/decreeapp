...
import { ProductSortKeys, CurrencyCode } from "./../../../../../__generated__/globalTypes";

// ====================================================
// GraphQL query operation: getProducts
// ====================================================

export interface getProducts_products_edges_node_options {
...
export interface getProducts_products_edges_node_subtitle {
...
export interface getProducts_products_edges_node_metafields_edges_node {
  __typename: "Metafield";
  /**
...
export interface getProducts_products_edges_node_metafields_edges {
  __typename: "MetafieldEdge";
  /**
   * The item at the end of MetafieldEdge.
   */
  node: getProducts_products_edges_node_metafields_edges_node;
}

export interface getProducts_products_edges_node_metafields {
  __typename: "MetafieldConnection";
  /**
   * A list of edges.
   */
  edges: getProducts_products_edges_node_metafields_edges[];
}
...
export interface getProducts_products_edges_node_media_edges_node_previewImage {
  __typename: "Image";
  /**
   * The location of the original image as a URL.
   * 
...
export interface getProducts_products_edges_node_media_edges_node {
  __typename: "ExternalVideo" | "MediaImage" | "Model3d" | "Video";
  /**
   * The preview image for the media.
   */
  previewImage: getProducts_products_edges_node_media_edges_node_previewImage | null;
}

export interface getProducts_products_edges_node_media_edges {
  __typename: "MediaEdge";
  /**
   * The item at the end of MediaEdge.
   */
  node: getProducts_products_edges_node_media_edges_node;
}

export interface getProducts_products_edges_node_media {
  __typename: "MediaConnection";
  /**
   * A list of edges.
   */
  edges: getProducts_products_edges_node_media_edges[];
}
...
export interface getProducts_products_edges_node {
   ...
   */
  options: getProducts_products_edges_node_options[];
  /**
   * Returns a metafield found by namespace and key.
   */
  subtitle: getProducts_products_edges_node_subtitle | null;
  /**
   * The price range.
   */
   ...
   */
  metafields: getProducts_products_edges_node_metafields;
  /**
   ...
   */
  media: getProducts_products_edges_node_media;
  /**
